function [G_red, x_red, b_red] = snow_gis_reduce(SNOW_GIS_DIR, ...
    downsample, neighbors)
...
%   Example:
%       [G_red, x_red, b_red] = snow_gis_reduce(SNOW_GIS_DIR)
%
%   See also: snow_gis.m
%
...
if nargin < 3; neighbors = []; end

%% Get full Snow GIS graph
[G, x, b] = snow_gis(SNOW_GIS_DIR, downsample);
