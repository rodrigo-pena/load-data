function [G_red, x_red, b_red, M] = snow_gis_reduce(SNOW_GIS_DIR, ...
    downsample, neighbors, neighbors_full)
...
%
%   Usage:
%       [G_red, x_red, b_red, M] = snow_gis_reduce(SNOW_GIS_DIR, ...
%           downsample, neighbors, neighbors_full)
%
%   Input:
...
%
%   Example:
%       G_red = snow_gis_reduce(SNOW_GIS_DIR)
%
%   See also: snow_gis.m
%
...
[G, x, b] = snow_gis(SNOW_GIS_DIR, downsample, neighbors_full);
